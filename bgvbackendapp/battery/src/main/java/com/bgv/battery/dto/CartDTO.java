...
public class CartDTO {
	...
	public CartDTO(Integer productId, String productName, String productBrand, int productMrp, int productRebate,
			int productQuantity, int pincode, boolean oldBattery, int price, Date cartDateTime) {
